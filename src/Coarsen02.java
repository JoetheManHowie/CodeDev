...
public class Coarsen02 {
     ...
     */
    public Coarsen02(String basename, int num_of_worlds) throws Exception{
	r = num_of_worlds;
	print("Loading Graph...");
	...
	Coarsen02 C = new Coarsen02(basename, number_of_world);
